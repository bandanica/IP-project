    ...
    <body>
        ...
        <div class="container-fluid sredina text-center">
            <div class="row pt-4 text-center justify-content-center">
                <div class="oglas text-center justify-content-center col">
                            ...
                            <div class="row pt-4">
                                ...
                                <form method="post" action="<?php echo site_url() . "oglasivac/zavrsiDodavanjeNekretnine" ?>"
                                    ...
                                    <div class="row pb-3">
                                        ...
                                        <div class="col text-start">
                                            <select id="opst" class="form-select" name="opst" onclick="promenaOpstina()" onload="promenaOpstina()">
                                                <option></option>
                                            </select>
                                        </div>
                                        <div class="col-2">
                                    ...
                                    <div class="row pb-3">
                                        ...
                                        <div class="col text-start">
                                            <textarea rows="5" class="form-control" cols="30" name="opisNek" onchange="proveraOpisa()"></textarea>
                                        </div>
                                        <div class="col-2"></div>
                                    </div>

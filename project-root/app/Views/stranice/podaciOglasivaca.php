                        ...
                        <form method='post' action=<?php echo site_url() . "oglasivac/promenaSubmit" ?>>
                            ...
                            <?php if (isset($podaci)) {
                                ...
                                <div class="row pb-3">
                                    ...
                                    <div class="col text-start">
                                        <input class="form-control" type="text" name="tel"
                                               value=<?php echo $podaci->getTelefon(); ?>>
                                    </div>
                                    <div class="col-2">
                                ...
                                <div class="row pb-3">
                                    ...
                                    <div class="col text-start">
                                        <input class="form-control" type="text" name="mejl"
                                               value=<?php echo $podaci->getEMail(); ?>>
                                    </div>
                                    <div class="col-2">
                                ...
                                <div id="agencija" class="text-center">
                                    ...
                                    <div class="row pb-3">
                                        ...
                                        <div class="col text-start">
                                            <input type="text" class="form-control" id="brlicence" name="brlicence1"
                                                   disabled value="<?php
